const Footer = () => {
    return(
        <footer className="text-white py-20 mt-35 px-30 flex justify-between border-t-1 border-[#FBD784]/20" data-aos="fade-up" >
            <div className="flex flex-col justify-between" data-aos="fade-up" data-aos-delay="200" >
                <div>
